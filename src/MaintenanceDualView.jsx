...
const MaintenanceDualView = () => {
  ...
  const supplierInfo = {
    '1月': { suppliers: '聚福155件、启瑞274件、诚美15件、方寸集15件、湖科1件、苏艺轩1件', secondarySuppliers: '当时未统计' },
    '2月': { suppliers: '聚福76件、启瑞105件、诚美8件、方寸集3件、柏星1件', secondarySuppliers: '当时未统计' },
    '3月': { suppliers: '聚福137件、方寸集8件、启瑞348件、诚美、苏艺、湖科、华超星12件', secondarySuppliers: '方寸集1件、聚福5件、启瑞57件' },
    '4月': { suppliers: '共计628件、刘郭209件、启瑞385件、方寸集17件、诚美13件、柏康、苏艺轩、帝亿、华超星14件', secondarySuppliers: '启瑞75件、聚福4件、方寸集2件' },
    '5月': { suppliers: '聚福141件、启瑞325件、方寸集10件、诚美27件、柏康、苏艺轩、帝亿、骏汇、卓汇、吉尔德、小锦鲤、盛程共11件', secondarySuppliers: '聚福9件、启瑞42件、诚美5件' },
    '6月': { suppliers: '聚福174件、启瑞258件、方寸集5件、诚美6件、苏艺轩2件、钰音、汐晨、华超星、小评、黄小仙共5件', secondarySuppliers: '聚福10件、启瑞25件、方寸集1件' },
    '7月': { suppliers: '总计522件、聚福165件、启瑞289件、诚美27件、平家1件、方寸集3件、柏音5件、湖科24件、汐晨2件、苏艺轩4件、黄小仙2件', secondarySuppliers: '启瑞6件、聚福10件、汐晨1件' },
    '8月': { suppliers: '聚福134件、启瑞265件、方寸集2件、诚美18件、黄小仙4件、湖科10件、骏航3件、钰音1件、南雅1件', secondarySuppliers: '聚福8件、启瑞27件、黄小仙1件' },
    '9月': { suppliers: '聚福128件、启瑞203件、诚美34件、方寸集6件、苏艺轩5件、柏音2件、金坚2件、湖科2级、黄小仙1件、南生1件', secondarySuppliers: '启瑞19件、聚福13件、诚美2件' },
    '10月': { suppliers: '聚福141件、启瑞320件、诚美17件、金坚5件、黄小仙1件、方寸集14件、湖科3件、吉尔德1件、科3件、王工1件、柏音1件', secondarySuppliers: '启瑞31件、聚福8件、诚美1件' },
    '11月': { suppliers: '聚福166件、启瑞368件、方寸集11件、诚美16件、启科3件、黄小仙2件、金坚2件、湖科1件、苏艺轩4件、柏音1件、宇家1件、传杭珠宝1件、吉尔德1件', secondarySuppliers: '启瑞14件、聚福2件' },
    '12月': { suppliers: '聚福189件、启瑞278件、诚美9件、方寸集16件、苏艺轩3件、柏音4件、华超星1件、小锦鲤1件、宇家1件、店科7件、湖科8件', secondarySuppliers: '启瑞22件、聚福10件、宇家1件、方寸集1件' }
  };

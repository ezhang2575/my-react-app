...
const MaintenanceDualView = () => {
  ...
  const supplierInfo = {
    '1月': { suppliers: '聚辉155件、启璨274件、诚美15件、万寸集15件、湖科1件、苏艺轩1件', secondarySuppliers: '当时未统计' },
    '2月': { suppliers: '聚辉76件、启璨105件、诚美8件、万寸集3件、柏星1件', secondarySuppliers: '当时未统计' },
    '3月': { suppliers: '聚辉137件、万寸集8件、启璨348件、诚美、苏艺、湖科、华超星12件', secondarySuppliers: '万寸集1件、聚辉5件、启璨57件' },
    '4月': { suppliers: '共计628件、刘郭209件、启璨385件、万寸集17件、诚美13件、柏康、苏艺轩、帝亿、华超星14件', secondarySuppliers: '启璨75件、聚辉4件、万寸集2件' },
    '5月': { suppliers: '聚辉141件、启璨325件、万寸集10件、诚美27件、柏康、苏艺轩、帝亿、骏汇、卓汇、吉尔德、小锦鲤、盛程共11件', secondarySuppliers: '聚辉9件、启璨42件、诚美5件' },
    '6月': { suppliers: '聚辉174件、启璨258件、万寸集5件、诚美6件、苏艺轩2件、钰音、汐晨、华超星、小评、黄小仙共5件', secondarySuppliers: '聚辉10件、启璨25件、万寸集1件' },
    '7月': { suppliers: '总计522件、聚辉165件、启璨289件、诚美27件、平家1件、万寸集3件、柏音5件、湖科24件、汐晨2件、苏艺轩4件、黄小仙2件', secondarySuppliers: '启璨6件、聚辉10件、汐晨1件' },
    '8月': { suppliers: '聚辉134件、启璨265件、万寸集2件、诚美18件、黄小仙4件、湖科10件、骏航3件、钰音1件、南雅1件', secondarySuppliers: '聚辉8件、启璨27件、黄小仙1件' },
    '9月': { suppliers: '聚辉128件、启璨203件、诚美34件、万寸集6件、苏艺轩5件、柏音2件、金坚2件、湖科2级、黄小仙1件、南生1件', secondarySuppliers: '启璨19件、聚辉13件、诚美2件' },
    '10月': { suppliers: '聚辉141件、启璨320件、诚美17件、金坚5件、黄小仙1件、万寸集14件、湖科3件、吉尔德1件、科3件、王工1件、柏音1件', secondarySuppliers: '启璨31件、聚辉8件、诚美1件' },
    '11月': { suppliers: '聚辉166件、启璨368件、万寸集11件、诚美16件、启科3件、黄小仙2件、金坚2件、湖科1件、苏艺轩4件、柏音1件、宇家1件、传杭珠宝1件、吉尔德1件', secondarySuppliers: '启璨14件、聚辉2件' },
    '12月': { suppliers: '聚辉189件、启璨278件、诚美9件、万寸集16件、苏艺轩3件、柏音4件、华超星1件、小锦鲤1件、宇家1件、店科7件、湖科8件', secondarySuppliers: '启璨22件、聚辉10件、宇家1件、万寸集1件' }
  };
